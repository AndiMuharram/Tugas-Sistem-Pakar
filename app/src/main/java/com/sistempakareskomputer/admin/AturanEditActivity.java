...
public class AturanEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.1.7/sp_eskomputer/get_daftar_gejala.php";
    private static final String url_update = "http://192.168.1.7/sp_eskomputer/update_aturan.php";
