package com.sistempakareskomputer.admin;
...
import com.sistempakareskomputer.MySingleton;
...
public class PenyakitEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.1.7/sp_eskomputer/get_penyakit.php";
    private static final String url_update = "http://192.168.1.7/sp_eskomputer/update_penyakit.php";
    private static final String url_delete = "http://192.168.1.7/sp_eskomputer/delete_penyakit.php";
