...
public class GejalaEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.1.7/sp_eskomputer/get_gejala.php";
    private static final String url_update = "http://192.168.1.7/sp_eskomputer/update_gejala.php";
    private static final String url_delete = "http://192.168.1.7/sp_eskomputer/delete_gejala.php";
